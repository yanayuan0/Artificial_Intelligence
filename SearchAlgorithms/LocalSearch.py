...
from BeamSearch import beam_search, stochastic_beam_search

def parse_input():
    parser = ArgumentParser()
    parser.add_argument("search", choices=["HC","SA","BS", "SBS"],
                        help="Local search algorithm to use: HC, SA, BS, or SBS")
