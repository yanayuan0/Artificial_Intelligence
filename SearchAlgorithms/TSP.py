...
class TSP:
    ...
    def best_neighbor(self, tour):
        ...
        best_cost = self.cost(allneighbors[0])
        best_tour = allneighbors[0]
    ...
    def random_neighbor(self, tour):
        ...
        new_tour = tour.move_city(num1, num2)
        return new_tour, self.cost(new_tour)
...
if __name__ == '__main__':
    ...
    print("\nbest neighbor: \n", problem.best_neighbor(tour)[0])
    print("\nbest cost: \n", problem.best_neighbor(tour)[1])
    print("\nrandom neighbor: \n", problem.random_neighbor(tour)[0])
    print("\nrandom cost: \n", problem.random_neighbor(tour)[1])
