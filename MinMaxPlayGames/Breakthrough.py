...
# some unicode character sequences that allow pretty-printing
RED   = u"\033[1;31m"  # change color of terminal printing to red
BLUE  = u"\033[1;34m"  # change color of terminal printing to blue
RESET = u"\033[0;0m"   # reset color to terminal default
CIRCLE = u"\u25CF"     # print a circle

RED_DISK = RED + CIRCLE + RESET
BLUE_DISK = BLUE + CIRCLE + RESET

class Breakthrough(Game):
    """Implements the board game Breakthrough using the Game base-class API.
    ...
    def __init__(self, height=6, width=5, game=None):
